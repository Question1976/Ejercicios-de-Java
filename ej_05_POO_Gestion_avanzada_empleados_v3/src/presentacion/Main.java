...
public class Main {
	...
	public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("9. Ordenar empleados por nombre");
            System.out.println("10. Ordenar empleados por salario");
            ...
            switch (opcion) {
                ...
                case 7:
                    var mayor = logicaEmpleado.obtenerEmpleadoMayorSalario();
                    System.out.println((mayor != null) ? "Empleado con mayor salario: " + mayor : "No hay empleados.");
                    break;

                case 8:
                    var menor = logicaEmpleado.obtenerEmpleadoMenorSalario();
