	        ...
	        switch(op){
		        ...
		        case 1:
	                ...
	                if (gestor.agregar(nombre, email,edad)) {
	                	...
	                	System.out.println("No se puede repetir email, o contacto no se pudo añadir");
	                }
	                break;
