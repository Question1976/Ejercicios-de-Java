...
public class MyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("Ingresamos al método POST de MyServlet");

		// Recibir los parámetros de 'index.jsp'
		// en la variable 'nombre' que viene del 
		// atributo 'name' del formulario
		System.out.println(request.getParameter("nombre"));
		
		// Forma 1 => mediante 'request'
		// Sólo se mantiene en el request
		...
		// Dura toda la sesión de la aplicación
		// Pasar variables desde 'MyServlet' a 'presentacion.jsp'
